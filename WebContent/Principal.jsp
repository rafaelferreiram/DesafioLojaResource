<%@page import="br.com.desafio.servlet.ImportacaoServlet"%>
<%@page import="br.com.desafio.domain.Produto"%>
<%@page import="java.util.List"%>
<%@page import="br.com.desafio.dao.ProdutoDao"%>
...
<body>
	<div><a href="http://localhost:8088/DesafioLojaResource/Principal.jsp"><img id ="logo"src="https://media-exp2.licdn.com/mpr/mpr/shrink_200_200/AAEAAQAAAAAAAAxOAAAAJDlhM2NhYzQyLThjOGItNDdkMi1iNmE1LWM2ODcyMzg2NjQxZA.png"></a>
	</div>
		...
		<form action="adicionaproduto" method="post" style="margin-top:30px;">
			...
			function verificaExtensao($input) {
				...
				function confirmarRemover(val){
					var url = 'http://localhost:8088/DesafioLojaResource/Remover?codigo='+ $(val).attr("data-id");
